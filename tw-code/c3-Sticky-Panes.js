...
$(document).on(":passageinit", () => {
  ...
  const headDiv = $("<div id=sticky-head>").prependTo("#story");
  const headObsDiv = $("<div id=sticky-head-obs>").prependTo("#story");
  ...
  const tailDiv = $("<div id=sticky-tail>").appendTo("#story");
  const tailObsDiv = $("<div id=sticky-tail-obs>").appendTo("#story");
